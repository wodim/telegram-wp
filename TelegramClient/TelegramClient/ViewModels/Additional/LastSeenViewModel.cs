...
namespace TelegramClient.ViewModels.Additional
{
    public class LastSeenViewModel : ViewModelBase, Telegram.Api.Aggregator.IHandle<TLUpdatePrivacy>
    {
            ...
            : base(cacheService, errorHandler, stateService, navigationService, mtProtoService, eventAggregator)
        {
            ...
            {
                new TLPrivacyValueAllowAll{ Label = AppResources.Everybody.ToLowerInvariant() },
                new TLPrivacyValueAllowContacts{ Label = AppResources.MyContacts.ToLowerInvariant() },
                new TLPrivacyValueDisallowAll{ Label = AppResources.Nobody.ToLowerInvariant() }
            };
