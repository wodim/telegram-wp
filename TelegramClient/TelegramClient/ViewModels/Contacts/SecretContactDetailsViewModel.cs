...
{
    public class SecretContactDetailsViewModel : PropertyChangedBase, Telegram.Api.Aggregator.IHandle<TLEncryptedChatBase>
    {
        public string DisplayName { get { return AppResources.SecretChat.ToLowerInvariant(); } }
